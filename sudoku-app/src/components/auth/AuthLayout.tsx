...
const AuthLayout = ({ children, title, subtitle }: { children: React.ReactNode, title: string, subtitle: string }) => {
  return (
    <div className="landing-body h-screen flex bg-landing-obsidian overflow-hidden">
      ...
      <div className="w-full lg:w-[60%] flex flex-col justify-center items-center p-4 md:p-8 relative">
